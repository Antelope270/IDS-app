...
st.markdown("#### Outcome: Filtered line chart")
...
sliders = {
    "Danceability": st.slider(
        "Danceability?", dance_min, dance_max, 0.56
    ),

    "Acousticness":st.slider(
        "Acousticness?", acoust_min, acoust_max, 0.495
    ),

    "Energy":st.slider(
        "Energy?", energy_min, energy_max, 0.51
    ),
    "Valence":st.slider(
        "Valence?", valence_min, valence_max, 0.50
    ),
...
# simple of line chart between danceability and popularity 
# x = ['Danceability']
# y = ['Popularity']
# p = figure(
